# =============================================================================
# FETAL HEALTH PREDICTION - COMPLETE SOLUTION (WITH BioBERT)
# =============================================================================
...
# =============================================================================
# STEP 1: GARBAGE FEATURE DETECTION USING BioBERT
# =============================================================================
...
def identify_garbage_features_biobert(df_train):
    """
    Identify bottom 10 features by semantic relevance using BioBERT.
    
    Returns:
        garbage_features: List of 10 least relevant features
    """
    ...
    for i, (feature, score) in enumerate(sorted_features):
        marker = "⚠ GARBAGE" if i < 10 else ""
        print(f"{i+1:2d}. {feature:40s} | {score:.4f} {marker}")
    
    # Bottom 10 are garbage
    garbage_features = [f for f, s in sorted_features[:10]]
    
    print(f"\n✓ Identified {len(garbage_features)} garbage features (bottom 10)")
...
def main():
    ...
    2. Identify garbage features (BioBERT or manual)
    ...
    if BIOBERT_AVAILABLE:
        try:
            print("\n" + "-"*70)
            print("DETECTING GARBAGE FEATURES USING BioBERT")
            print("-"*70)
            garbage_features = identify_garbage_features_biobert(df_train)
